...
public class App {
    ...
    public App() {
        JFrame frame = new JFrame("Пять в ря-я-я-я-яд!");
        frame.setTitle("Пять в р-я-я-я-я-яд!");
        ...
        JLabel label = new JLabel("Скорее тыкай на кнопки!");
        ...
        showResultButton.addActionListener(_ -> {
